from testes_automatizados.src.dominio import Usuario, Leilao
import pytest

from testes_automatizados.tests.excecoes import LanceInvalido
...
def test_deve_permiter_lance_quando_o_valor_eh_menor_que_a_carteira(vini, leilao):
